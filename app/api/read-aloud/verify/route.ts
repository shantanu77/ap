    ...
    return {
      ...
      feedback:
        typeof parsed.feedback === "string" && parsed.feedback.trim()
          ...
          : correct
          ? "Answer accepted. Next, make the response stronger by using a complete sentence and avoiding filler words like um or uh."
          : "Answer needs more detail from the passage. Try again in a complete sentence and avoid filler words like um or uh.",
    };
  } catch {
    return {
      correct: false,
